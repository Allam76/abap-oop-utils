class ZCL_OOP_STRING definition
  public
...
*"* public components of class ZCL_OOP_STRING
...
protected section.
*"* protected components of class ZCL_OOP_STRING
*"* do not include other source files here!!!
private section.

*"* private components of class ZCL_OOP_STRING
*"* do not include other source files here!!!
  class-methods _MIN
    importing
      !INT1 type I
...
CLASS ZCL_OOP_STRING IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Public Method ZCL_OOP_STRING=>DISTANCE
* +-------------------------------------------------------------------------------------------------+
* | [--->] STRING1                        TYPE        STRING
* | [--->] STRING2                        TYPE        STRING
* | [<-()] RETURNING                      TYPE        I
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Private Method ZCL_OOP_STRING=>_MIN
* +-------------------------------------------------------------------------------------------------+
* | [--->] INT1                           TYPE        I
* | [--->] INT2                           TYPE        I
* | [--->] INT3                           TYPE        I
