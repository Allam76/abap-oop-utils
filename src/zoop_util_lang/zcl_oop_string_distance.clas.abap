class ZCL_OOP_STRING_DISTANCE definition
  public
...
*"* public components of class ZCL_OOP_STRING_DISTANCE
...
protected section.
*"* protected components of class ZCL_OOP_STRING_DISTANCE
*"* do not include other source files here!!!
private section.

*"* private components of class ZCL_OOP_STRING_DISTANCE
*"* do not include other source files here!!!
  class-methods _MIN
    importing
      !INT1 type I
...
CLASS ZCL_OOP_STRING_DISTANCE IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Public Method ZCL_OOP_STRING_DISTANCE=>DISTANCE
* +-------------------------------------------------------------------------------------------------+
* | [--->] STRING1                        TYPE        STRING
* | [--->] STRING2                        TYPE        STRING
* | [<-()] RETURNING                      TYPE        I
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Static Private Method ZCL_OOP_STRING_DISTANCE=>_MIN
* +-------------------------------------------------------------------------------------------------+
* | [--->] INT1                           TYPE        I
* | [--->] INT2                           TYPE        I
* | [--->] INT3                           TYPE        I
