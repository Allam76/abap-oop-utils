...
*"* public components of class ZCL_OOP_HTTP
...
protected section.
*"* protected components of class ZCL_OOP_HTTP
*"* do not include other source files here!!!
private section.
*"* private components of class ZCL_OOP_HTTP
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_OOP_HTTP IMPLEMENTATION.
ENDCLASS.
