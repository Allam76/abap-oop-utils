class ZCL_OOP_HTTP_STATUS_CODES definition
  public
...
*"* public components of class ZCL_OOP_HTTP_STATUS_CODES
...
protected section.
*"* protected components of class ZCL_OOP_HTTP_STATUS_CODES
*"* do not include other source files here!!!
private section.
*"* private components of class ZCL_OOP_HTTP_STATUS_CODES
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_OOP_HTTP_STATUS_CODES IMPLEMENTATION.
ENDCLASS.
