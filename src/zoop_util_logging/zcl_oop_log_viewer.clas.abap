class ZCL_OOP_LOG_VIEWER definition
  public
...
*"* do not include other source files here!!!
  ...
  methods DISPLAY
    importing
      !LOGGER type ref to zcl_oop_logger .
  methods DISPLAY_LIST
    importing
      !LOGGER_LIST type ref to zif_oop_list .
...
CLASS ZCL_OOP_LOG_VIEWER IMPLEMENTATION.
...
* +--------------------------------------------------------------------------------------</SIGNATURE>
method display_list.
  data: logger_list_iterator type ref to zif_oop_iterator,
        logger type ref to zcl_oop_logger,
        handles type bal_t_logh,
