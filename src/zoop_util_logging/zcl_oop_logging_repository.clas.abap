class ZCL_OOP_LOGGING_REPOSITORY definition
  public
  inheriting from ZCL_oop_OBJECT
  create public

  global friends ZCL_oop_LOGGING_RESOURCE .

public section.

*"* public components of class ZCL_OOP_LOGGING_REPOSITORY
...
protected section.
*"* protected components of class ZCL_OOP_LOGGING_REPOSITORY
*"* do not include other source files here!!!
private section.
*"* private components of class ZCL_OOP_LOGGING_REPOSITORY
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCL_OOP_LOGGING_REPOSITORY IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_OOP_LOGGING_REPOSITORY->ZIF_oop_LOGGING_REPOSITORY~CREATE
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_OOP_LOGGING_REPOSITORY->ZIF_oop_LOGGING_REPOSITORY~FIND_BY_ID
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_OOP_LOGGING_REPOSITORY->ZIF_oop_LOGGING_REPOSITORY~UPDATE
* +-------------------------------------------------------------------------------------------------+
* | [--->] LOG_NUMBER                     TYPE        BALOGNR
